...
const glassStyles = computed(() => getGlassStyle(props.color, 'container'))
</script>
...
<template>
  <div class="daily-summary-component">
    ...
    <div class="metrics-row-component" :style="glassStyles">
      <div class="metric-block">
        <div class="metric-icon">
          <svg width="36" height="36" viewBox="4.5 2 15 18" fill="none">
            <path
        ...
        <div class="metric-value-component" style="color: black">
          {{ wind }}
        </div>
        <div class="metric-label-component" style="color: black">{{ $t('weather.wind') }}</div>
      </div>
      ...
      <div class="metric-block">
        ...
        <div class="metric-label-component" style="color: black">
          {{ $t('weather.humidity') }}
        </div>
      </div>
...
.metrics-row-component {
  ...
  align-items: center;
  /* Les styles de glassmorphisme sont maintenant dynamiques via :style */
  border-radius: 24px;
  padding: 25px 20px;
...
.metrics-row-component:hover {
  /* Le hover est maintenant géré par la logique dynamique */
